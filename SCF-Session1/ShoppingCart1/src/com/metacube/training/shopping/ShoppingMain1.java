	...
	public static void main(String args[]) {
		...
		while (flag) {
			...
			case 4:
				...
				break;
			case 5:
				System.out.println("Any Promocode?");
				System.out.println("enter y if yes and n if no");
				String promoChoice = sc.next();
				if (Constants.YES.equals(promoChoice)) {
					System.out.print("enter promocode:");
					String promoCode = sc.next();
					itemObject.setPromoCode(promoCode);
					double discount = itemObject.applyTypeOfDiscount();
					if (discount <= 0) {
						System.out.println("invalid coupon");
					}
					itemObject.display();
					double totalAmount = itemObject.totalAmount();
