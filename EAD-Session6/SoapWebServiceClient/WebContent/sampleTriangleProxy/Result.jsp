...
<jsp:useBean id="sampleTriangleProxyid" scope="session" class="com.metacube.soap.TriangleProxy" />
<%
...
case 10:
        gotMethod = true;
        com.metacube.soap.Triangle getTriangle10mtemp = sampleTriangleProxyid.getTriangle();
...
case 13:
        ...
        double areaOfTriangle13mtemp = sampleTriangleProxyid.areaOfTriangle(side1_1idTemp,side2_2idTemp,side3_3idTemp);
