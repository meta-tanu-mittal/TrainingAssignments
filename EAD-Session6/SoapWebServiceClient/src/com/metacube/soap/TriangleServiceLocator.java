...
public class TriangleServiceLocator extends org.apache.axis.client.Service implements com.metacube.soap.TriangleService {
    ...
    public com.metacube.soap.Triangle getTriangle(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.metacube.soap.TriangleSoapBindingStub _stub = new com.metacube.soap.TriangleSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.metacube.soap.Triangle.class.isAssignableFrom(serviceEndpointInterface)) {
                com.metacube.soap.TriangleSoapBindingStub _stub = new com.metacube.soap.TriangleSoapBindingStub(new java.net.URL(Triangle_address), this);
                _stub.setPortName(getTriangleWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://soap.metacube.com", "TriangleService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://soap.metacube.com", "Triangle"));
        }
